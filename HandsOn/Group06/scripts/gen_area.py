...
geolocator = Nominatim(user_agent="group06_area_generator")
# Rate limiter: 1 request per second to respect Nominatim usage policy
...
def get_location_info(lat, lon):
    ...
    """
    try:
        location = geocode(f"{lat}, {lon}", language="es", addressdetails=True)
