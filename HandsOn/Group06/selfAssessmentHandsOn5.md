...
- [X] Links a resource in the dataset with another resource in an external dataset (Wikidata)
...
Our RDF dataset includes `owl:sameAs` links connecting LocalArea resources to Wikidata entities. The `local_areas-with-links.csv` file contains Wikidata URIs for geographic areas in Madrid.
