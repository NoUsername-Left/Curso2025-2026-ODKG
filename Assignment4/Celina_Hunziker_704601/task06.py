...
Original file is located at
    https://colab.research.google.com/drive/1_UqQ3HSgft3SfS7dONe3oqlpkJFDHzop
...
g.bind("ontology", ontology, override=True)
g.bind("person", person, override=True)
...
# ontology:AssociateProfessor  rdfs:subClassOf ontology:Professor
...
# ontology:InterimAssociateProfessor  rdfs:subClassOf ontology:AssociateProfessor
...
# ontology:FullProfessor  rdfs:subClassOf ontology:Professor
...
# (Opcional) ver resultado en Turtle
...
g.add((ontology.hasName, RDFS.range, RDFS.Literal))   # literal (string)
...
g.add((ontology.hasHomePage, RDFS.range, RDFS.Literal))  # sin range en el slide → literal (string)
...
g.add((ontology.hasColleague, RDFS.range, ontology.Person))  # según el diagrama
...
# Relaciones de colega (direcciones como en la lámina)
...
g.add((person.Oscar, FOAF.email, Literal("jsmith@example.org", datatype=XSD.string)))
