...
Original file is located at
    https://colab.research.google.com/drive/1c1fwr8Yc60E9LsVlsLgSwhJfIS2HPKtc
...
g = Graph()
g.namespace_manager.bind('ns', Namespace("http://somewhere#"), override=False) # \@prefix ns
r = Report()
...
g.namespace_manager.bind('ontology', ontology, override=False) #Normally used to define vocabularies
g.namespace_manager.bind('person', person, override=False) #to define instances

"""**TASK 6.1: Reproduce the taxonomy of classes shown in slide 34 in class (all the classes under "Vocabulario", Slidedeck: 01a.RDF(s)-SPARQL). Add labels for each of them as they are in the diagram (exactly) with no language tags. Remember adding the correct datatype (xsd:String) when appropriate**

"""

# TO DO, all the classes under "Vocabulario". This means only write the taxonomy.

# Definition of classes and hierarchical relationships
...
g.add((ontology.hasColleague, RDFS.range, ontology.Person))  # another person
...
g.add((person.Asun, ontology.hasHomePage, Literal("http://www.oeg.fi.upm.es/", datatype=XSD.string)))
...
# Añadir manualmente los namespaces de example4
...
# Asegurarnos de que Oscar está definido como Person
g.add((person.Oscar, RDF.type, ontology.AssociateProfessor))

# Añadir propiedades vcard-rdf y foaf
...
# Visualize the results (of Oscar´s triples)
