...
Original file is located at
    https://colab.research.google.com/drive/1TOdm6UsnrixsMBAgVWpLk65cW5PHpBBq
...
g.namespace_manager.bind('pers', pers, override= False)
...
# TO DO
g.add((pers.Oscar, RDF.type, ont.AssociateProfessor))
g.add((pers.Asun, RDF.type, ont.FullProfessor))
g.add((pers.Raul, RDF.type, ont.InterimAssociateProfessor))

g.add((pers.Oscar, ont.hasName, Literal("Óscar Corcho García", datatype=XSD.string)))
g.add((pers.Asun, ont.hasHomePage, Literal("http://oeg.fi.upm.es/", datatype=XSD.string)))

g.add((pers.Oscar, ont.hasColleague, pers.Asun))
g.add((pers.Asun, ont.hasColleague, pers.Raul))

g.add((pers.Oscar, RDFS.label, Literal("Oscar", datatype=XSD.string)))
g.add((pers.Asun, RDFS.label, Literal("Asun", datatype=XSD.string)))
g.add((pers.Raul, RDFS.label, Literal("Raul", datatype=XSD.string)))
...
g.add((pers.Oscar, foaf.email, Literal("oscar@gmail.com", datatype= XSD.string)))
g.add((pers.Oscar, vcard.Given, Literal("Óscar", datatype= XSD.string)))
g.add((pers.Oscar, vcard.Family, Literal("Corcho Gracía", datatype= XSD.string)))
